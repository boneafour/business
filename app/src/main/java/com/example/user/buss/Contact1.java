...
public class Contact1 extends Activity implements View.OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.view:
				Toast.makeText(Contact1.this, "Доступ открыто только для админа!", Toast.LENGTH_SHORT).show();
				break;
				}
		}
	}
