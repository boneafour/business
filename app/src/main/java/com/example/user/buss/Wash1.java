...
public class Wash1 extends Activity implements View.OnClickListener, MultiSelectionSpinner.OnMultipleItemsSelectedListener  {
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.loginButton:
				...
				Toast.makeText(Wash1.this, "Сохранено", Toast.LENGTH_SHORT).show();
				break;
			case R.id.send:
				ListS = ""+list.getSelectedItem().toString();
				DataS = ""+Data.getText();
	...
	protected void sendEmail() {
		...
		try {
			...
			Toast.makeText(Wash1.this, "Отправлено", Toast.LENGTH_SHORT).show();
		}
	}
