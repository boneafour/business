...
public class Clean1 extends Activity implements View.OnClickListener,MultiSelectionSpinner.OnMultipleItemsSelectedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list = (Spinner) findViewById(R.id.type);
		...
		Button save = (Button) findViewById(R.id.loginButton);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.loginButton:
				...
				Toast.makeText(Clean1.this, "Сохранено", Toast.LENGTH_SHORT).show();
					break;
			case R.id.send:
				ListS = "" + list.getSelectedItem().toString();;
				DataS = "" + Data.getText();
	...
	protected void sendEmail() {
		...
		try {
			...
			Toast.makeText(Clean1.this, "Отправлено", Toast.LENGTH_SHORT).show();
		}
	}
